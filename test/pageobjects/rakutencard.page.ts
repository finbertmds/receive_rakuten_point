...
class RakutenCardPage extends Page {
  ...
  get labelClickPointCountTxt() {
    return $(".sprite-ico_rc_enavi_point_01 > .top-edit-total-click-point");
  }
  get btnClickPointCountLink() {
    return $(".sprite-ico_rc_enavi_point_01");
  }

  get videoBtn() {
    return $("#vjs_video_3 > button");
  }
  get videoGetPointImg() {
    return $(".js-movie-point-finish");
  }
