...
class InfoseekPage extends Page {
  ...
  get btnNextV2() {
    return $$(".h4k5-e2e-button__submit");
  }
  get btnLoginConfirmV2() {
    return $("#prim_continue");
  }
  ...
  get notificationModal() {
    return $("#notification_banner_modal");
  }
   ...
   */
  get modalContents() {
    return $(".modalClick_contents");
  }
  get modalContentsCloseButton() {
    return $(".modalClick_close");
  }

  get dialogContainer() {
    return $(".fc-monetization-dialog-container");
  }
  get dialogAdButton() {
    return $(".fc-rewarded-ad-button");
  }
  get adButtonAfter() {
    return $("#dismiss-button-element");
  }

  /**
   * mission page
   */
  get btnMissionJoinList() {
    return $$(".list-challenge .btn");
  }
  get btnMissionJoin() {
    return $(".list-challenge .btn");
  }
  get btnMissionAgree() {
    return $("//a[contains(text(),'同意する')]");
  }
  get btnGetPointList() {
    return $$(".list-acquired .btn");
  }
  get btnGetPoint() {
    return $(".list-acquired .btn");
  }
   ...
   */
  get fcDialogContent() {
    return $(".fc-dialog-content");
  }
  get fcRewardedAdButton() {
    return $(".fc-rewarded-ad-button");
  }
  get fcCloseButton() {
   ...
   * reaction
   */
  get reactionIconIine() {
    return $(".reaction-icon.-iine");
  }
  ...
  async isNotLoggedInV2(): Promise<boolean> {
    let inputUsernameIsDisplayed = await (
      await this.inputUsernameV2
    ).isDisplayed();
    let inputPasswordIsDisplayed = await (
      await this.inputPasswordV2
    ).isDisplayed();
